namespace GetLabourManager.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.SequenceNumberings",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        SequenceName = c.String(nullable: false, maxLength: 70),
                        SequenceNumber = c.Int(nullable: false),
                        SequenceLength = c.Int(nullable: false),
                        SequencePrefix = c.String(maxLength: 10),
                        SequenceSuffix = c.String(maxLength: 10),
                        SequenceType = c.String(nullable: false, maxLength: 70),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.USERS");
            DropTable("dbo.SequenceNumberings");
